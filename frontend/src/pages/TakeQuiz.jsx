...
const TakeQuiz = () => {
 ...
 const handleSubmit = async () => {
    // 1. Calculate final score immediately
    ...
    const resultData = {
      ...
      timeTaken: (quiz.timeLimit * 60) - timer // Calculate how many seconds passed
    };

    // 3. Send to Database
    try {
      await axios.post(`${API_BASE_URL}/api/results`, resultData);
